...
describe("POST /api/post", () => {
  ...
  describe("POST /api/post 'user actions'", () => {
    it("should add to post number of likes", (done) => {
      request(app)
  ...
  it("should add comments to post", (done) => {
    request(app)
  ...
  it("should save post for user", (done) => {
    request(app)
      .post("/api/post/1")
      .send({ user_id: 1 })
      .set("Accept", "application/json")
  ...
  it("should hide post for user", (done) => {
    request(app)
      .post("/api/post/1")
      .send({ user_id: 1 })
      .set("Accept", "application/json")
